...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../ipstatic" +incdir+"../../../../ASCONTESISPERIMENTALE.gen/sources_1/ip/PLL_2" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../ipstatic" +incdir+"../../../../ASCONTESISPERIMENTALE.gen/sources_1/ip/PLL_2" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/run/media/ace96/BACKUPSSD/Lavoro/Universita/Tesisti/Dannibale/project_ascon_final/ASCONTESISPERIMENTALE.cache/compile_simlib/xcelium"
  fi
