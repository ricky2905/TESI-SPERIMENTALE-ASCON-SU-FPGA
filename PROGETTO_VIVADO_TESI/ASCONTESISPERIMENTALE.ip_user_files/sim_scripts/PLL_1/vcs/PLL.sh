...
#
# Script generated by Vivado on Fri Oct 10 17:16:21 CEST 2025
...
# script info
echo -e "PLL.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../ipstatic" +incdir+"../../../../ASCONTESISPERIMENTALE.gen/sources_1/ip/PLL_2" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../ipstatic" +incdir+"../../../../ASCONTESISPERIMENTALE.gen/sources_1/ip/PLL_2" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/run/media/ace96/BACKUPSSD/Lavoro/Universita/Tesisti/Dannibale/project_ascon_final/ASCONTESISPERIMENTALE.cache/compile_simlib/vcs"
  fi
